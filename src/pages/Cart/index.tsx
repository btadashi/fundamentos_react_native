...
const Cart: React.FC = () => {
  ...
  function handleIncrement(id: string): void {
    /** Passamos o 'id' que estamos recebendo como parâmetro para dentro de 'increment' */
    increment(id);
  }

  function handleDecrement(id: string): void {
    /** Passamos o 'id' que estamos recebendo como parâmetro para dentro de 'decrement' */
    decrement(id);
  }
